...
PRO TKH_Rot_DTH20150731, N_trajectories = N_trajectories, $ ;Number of output files/trajectories
...
FOR i=1, n_elements(texs[*,0])-1 DO BEGIN
  ...
  FOR step = 0, fix((texs[i,n]-texs[i-1,n]-1.)/100000) DO BEGIN
    ...
    IF N_Elements(D_ROTATION) NE 0 THEN $
         Rotation_Jumps = TKH_ROT_JUMP_DISTRIBUTION_20130513(D_ROTATION[i,n], N_POINTS=100000) $
       ELSE Rotation_Jumps = make_array(100000,value=rotation_angle[n])
    ...
    FOR j=0L,99999 DO BEGIN ;100,000 iterations
